...
import slide1 from "../assets/arkaplan4.jpg";
      ...
      <Carousel showThumbs={false}>
        <StyledStyle imgUrl={slide1}>
          ...
          <br/>
            ...
            Staj evrakları için yana kaydırınız.</p>
          </div>
        </StyledStyle>
          ...
          <div className="text-container">
            <ul className="list-group">
              ...
              <li className="list-group-item">
                ...
                <a target="_blank" href="files/StajBasvuruKabulFormu.docx">
                  Tıklayınız
                </a>
              </li>
              <li className="list-group-item">
                ...
                <a
                  target="_blank"
                  href="files/stajdegerlendirmeformu.doc"
                >
                  Tıklayınız
                </a>
              </li>
              <li className="list-group-item">
                Staj Raporu{" "}
                <a target="_blank" href="files/stajraporu.docx">
                  Tıklayınız
                </a>
              </li>
              <li className="list-group-item">
              ...
              <li className="list-group-item">
                ...
                <a
                  target="_blank"
                  href="files/devletkatkitalepformu.xlsx"
                >
                  Tıklayınız
                </a>
              </li>
